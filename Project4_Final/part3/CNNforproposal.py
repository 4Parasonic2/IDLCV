...
END_PATH = "~/courses/02516/IDLCV/Project4_Final/part3"
SPLITS_PATH = os.path.join(END_PATH, "splits.json")
LABELED_PROPOSALS_PATH = os.path.join(END_PATH, "labeled_proposals_train.json")
LABELED_PROPOSALS_VAL = os.path.join(END_PATH, "labeled_proposals_val.json")  
...
if __name__ == "__main__":
    ...
    # model = ProposalClassifier(num_classes=2, pretrained=True)
